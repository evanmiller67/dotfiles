...
alias noises='play -qn -t sl -r48000 -c2 - synth -1 brownnoise tremolo .1 20 gain -12 < /dev/zero &  play -qn -t sl -r48000 -c2 - synth -1 pinknoise tremolo .1 10 gain -12 < /dev/zero &'
